        ...
        {  
          ...
          echo '<tr><td>'.$row["name"].'</td>';
                    ...
                    if($ava == 'Available'){
                        ...
                        echo '<td><button class="waves-effect waves-light btn green" style="pointer-events: none;"> AVAILABLE</Button></td>';
                        
                    }
                    else
                        echo '<td><button class="waves-effect waves-light btn red" style="pointer-events: none;">NOT AVAILABLE</Button></td>';

echo '<td><a class="waves-effect waves-light btn right" style="background-color:  #168F99;color:#FFD033" href="edit.php?edit='.$row["id"].'" name="submit" type="submit" role="button">Edit<i class="mdi-editor-border-color"></a></td></tr>';
        ...
        <div class="input-field col s12">
                              <button class="waves-effect waves-light btn right" style="background-color:  #168F99;color:#FFD033"  type="submit" name="action">Add Items
