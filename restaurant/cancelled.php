...
<!-- START CONTENT -->
      <section id="content">
        ...
        <!--start container-->
        <div class="container">
          <p class="caption">Details of Cancelled Order</p>
...
<div id="work-collections" class="seaction">
          ...
          $sql = mysqli_query($conn, "SELECT * FROM orders WHERE status='Cancelled by Customer' or status='Cancelled by admin' ");
          echo '              <div class="row">
                <div>
            ...
            while($row1 = mysqli_fetch_array($sql1))
            {
              ...
              $oid = $row1['oid'];
                ...
                echo '<form action="cancelorder.php" method="post">
                    ...
                    <button class="btn waves-effect waves-light right submit green " type="submit" name="action">Delivered 
                    </button>
                    </form>';
                }
